...
{
    public const string NAME_SPACE = "_KarpProd/GameSettings";
    ...
    */
    ...
    {
        SettingProviderBase<T> setProvidBase = new SettingProviderBase<T>(NAME_SPACE + "/" + typeof(T).Name, SettingsScope.Project);
    ...
    //{
    //    SettingProviderBase<T> setProvidBase = new SettingProviderBase<T>(NAME_SPACE + "/" + typeof(T).Name, SettingsScope.User);
    //    setProvidBase.guiHandler = OnProviderGUI;
    //    return setProvidBase;
    //}
